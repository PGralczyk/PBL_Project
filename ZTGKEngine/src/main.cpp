...
int main(void)
{
    ...
    Shader shhader("res/shaders/text.vert", "res/shaders/text.frag");
    glm::mat4 projectionPrimitive = glm::ortho(0.0f, float(SCR_WIDTH), 0.0f, float(SCR_HEIGHT));
    shhader.use();
    shhader.setMat4("projection", projectionPrimitive);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        world->Draw();
        text.RenderText(shhader, to_string(time), 100, 100, 0.5, glm::vec3(0.9, 0.1f, 0.1f));
