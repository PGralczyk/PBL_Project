...
#pragma region Camera Positions
    ...
    defaultCameraPosition.view = glm::mat4(
        ...
        -3.49246e-10, 0.956305, 0.352372, 0,
        -0.999999, 0.000509512, -0.00166654, 0,
        -0.0471941, -0.12073, -1.0546, 1);
 
    chessCameraPosition.position = { -0.134225, 0.4812, - 0.164045};
    ...
    chessCameraPosition.view = glm::mat4(
        -0.596227, - 0.585227, 0.549565, 0,
        - 1.49012e-08, 0.684547, 0.728969, 0,
        - 0.802816, 0.434631, - 0.408146, 0,
        - 0.211727, - 0.336657, - 0.343969, 1
    );
